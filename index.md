...
<div class="hero">
  <h1>Alex<br>Cordeiro</h1>
</div>

<div class="manifest">
  <div class="manifest-item">
    <div class="manifest-label">Função</div>
    <div class="manifest-value">Líder Técnico em Engenharia de Dados</div>
  </div>

  <div class="manifest-item">
    <div class="manifest-label">Base</div>
    <div class="manifest-value">Santos, SP, Brasil</div>
  </div>
